...
def main():
    ...
    # Reshape for 1D CNN: (samples, timesteps=number_of_features, channels=1)
    # Here, features vector length = number_of_timesteps, and we treat each dimension as a timestep with 1 channel.
    X = X[..., np.newaxis]
